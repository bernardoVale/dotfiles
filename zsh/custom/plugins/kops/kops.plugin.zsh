...
_kops_edit_federation()
{
    last_command="kops_edit_federation"
    commands=()
...
_kops_get_federations()
{
    last_command="kops_get_federations"
    commands=()
...
_kops_secrets_create()
{
    last_command="kops_secrets_create"
    commands=()
...
_kops_secrets_describe()
{
    last_command="kops_secrets_describe"
    commands=()
...
_kops_secrets_expose()
{
    last_command="kops_secrets_expose"
    commands=()
...
_kops_update_federation()
{
    last_command="kops_update_federation"
    commands=()
